...
(function(addon) {
    ...
    UI.component('pagination', {
        ...
        _render: function() {
            ...
            if (interval.start > 0 && o.edges > 0) {
                ...
                if (o.edges < interval.start && (interval.start - o.edges != 1)) {
                    this.element.append('<a class="item">...</a>');
        ...
        _append: function(pageIndex, opts) {
            ...
            item = (pageIndex == this.currentPage) ? '<a class="item active">' + (options.text) + '</a>'
                                                   : '<a class="item" href="?page='+(pageIndex+1)+'" data-page="'+pageIndex+'">'+options.text+'</a>';
